...
def strip_n_fill(df,outliers=False):
...
def read_parquet_batch(cwd, fdir, file_list, seq_length, scaleX=None, scaleT=None, debug=False,outliers=False):
    ...
    for file in file_list:
        ...
        Xdf, Tdf = strip_n_fill(df,outliers)
...
def read_parquet_flight_merge(cwd, fdir, file_list, seq_length, scaleX=None, scaleT=None, outliers=False):
